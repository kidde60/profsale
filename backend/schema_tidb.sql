-- ============================================================
-- Database: prof_sale
-- Consolidated Schema — all indexes, PKs, AUTO_INCREMENT, and
-- foreign keys are defined inline at table creation time.
-- Generated from original phpMyAdmin dump (MariaDB 10.4.28)
-- ============================================================
...
-- ============================================================
-- Disable FK checks during creation so table order doesn't
-- matter, then re-enable after all tables exist.
-- ============================================================
SET FOREIGN_KEY_CHECKS = 0;

-- --------------------------------------------------------
-- Table: users
-- (defined first; many tables reference it)
-- --------------------------------------------------------
CREATE TABLE `users` (
...
-- (defined before business_subscriptions which references it)
-- --------------------------------------------------------
...
CREATE TABLE `activity_logs` (
  ...
  CONSTRAINT `activity_logs_ibfk_1` FOREIGN KEY (`business_id`) REFERENCES `businesses` (`id`) ON DELETE CASCADE,
  CONSTRAINT `activity_logs_ibfk_2` FOREIGN KEY (`staff_id`)    REFERENCES `staff_members` (`id`) ON DELETE SET NULL
...
CREATE TABLE `business_subscriptions` (
  ...
  CONSTRAINT `business_subscriptions_ibfk_1` FOREIGN KEY (`business_id`) REFERENCES `businesses`         (`id`) ON DELETE CASCADE,
  CONSTRAINT `business_subscriptions_ibfk_2` FOREIGN KEY (`plan_id`)     REFERENCES `subscription_plans` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `business_users` (
  ...
  KEY `idx_business_users_role`            (`role`),

  CONSTRAINT `business_users_ibfk_1` FOREIGN KEY (`business_id`) REFERENCES `businesses` (`id`) ON DELETE CASCADE,
  CONSTRAINT `business_users_ibfk_2` FOREIGN KEY (`user_id`)     REFERENCES `users`       (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `customers` (
  ...
  FULLTEXT KEY `idx_customers_search` (`name`,`phone`,`email`),
...
CREATE TABLE `expenses` (
  ...
  CONSTRAINT `expenses_ibfk_1` FOREIGN KEY (`business_id`) REFERENCES `businesses` (`id`) ON DELETE CASCADE,
...
CREATE TABLE `inventory_movements` (
  ...
  PRIMARY KEY (`id`),
  KEY `created_by`                             (`created_by`),
  KEY `idx_inventory_movements_product_date`   (`product_id`,`movement_date`),
  ...
  CONSTRAINT `inventory_movements_ibfk_2` FOREIGN KEY (`product_id`)  REFERENCES `products`   (`id`) ON DELETE CASCADE,
...
CREATE TABLE `notifications` (
  ...
  PRIMARY KEY (`id`),
  KEY `user_id`                         (`user_id`),
  KEY `idx_notifications_business_user` (`business_id`,`user_id`),
...
CREATE TABLE `products` (
  ...
  PRIMARY KEY (`id`),
  KEY `created_by`                    (`created_by`),
  KEY `idx_products_business_active`  (`business_id`,`is_active`),
  KEY `idx_products_category`         (`category_id`),
  KEY `idx_products_barcode`          (`barcode`),
  KEY `idx_products_name`             (`name`),
  KEY `idx_products_stock_level`      (`current_stock`,`min_stock_level`),
...
CREATE TABLE `receipt_templates` (
  ...
  CONSTRAINT `receipt_templates_ibfk_1` FOREIGN KEY (`business_id`) REFERENCES `businesses` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `sales` (
  ...
  KEY `idx_sales_number`                 (`sale_number`),
  KEY `idx_sales_opening_balance`        (`is_opening_balance`),

  CONSTRAINT `sales_ibfk_1` FOREIGN KEY (`business_id`) REFERENCES `businesses` (`id`) ON DELETE CASCADE,
  CONSTRAINT `sales_ibfk_2` FOREIGN KEY (`employee_id`) REFERENCES `users`      (`id`),
...
CREATE TABLE `payment_records` (
  ...
  CONSTRAINT `payment_records_ibfk_1` FOREIGN KEY (`business_id`) REFERENCES `businesses` (`id`) ON DELETE CASCADE,
  CONSTRAINT `payment_records_ibfk_2` FOREIGN KEY (`sale_id`)     REFERENCES `sales`       (`id`) ON DELETE CASCADE,
  CONSTRAINT `payment_records_ibfk_3` FOREIGN KEY (`recorded_by`) REFERENCES `users`       (`id`)
...
CREATE TABLE `refunds` (
  ...
  KEY `idx_refunds_business`     (`business_id`),
  KEY `idx_refunds_sale`         (`sale_id`),
  KEY `idx_refunds_date`         (`refund_date`),
  KEY `idx_refunds_number`       (`refund_number`),

  CONSTRAINT `refunds_ibfk_1` FOREIGN KEY (`business_id`) REFERENCES `businesses` (`id`) ON DELETE CASCADE,
  CONSTRAINT `refunds_ibfk_2` FOREIGN KEY (`sale_id`)     REFERENCES `sales`      (`id`) ON DELETE CASCADE,
  CONSTRAINT `refunds_ibfk_3` FOREIGN KEY (`refunded_by`) REFERENCES `users`      (`id`)
...
CREATE TABLE `staff_members` (
  ...
  CONSTRAINT `staff_members_ibfk_1` FOREIGN KEY (`business_id`) REFERENCES `businesses` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `staff_permissions` (
  ...
  CONSTRAINT `staff_permissions_ibfk_1` FOREIGN KEY (`staff_id`) REFERENCES `staff_members` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `stock_records` (
  ...
  CONSTRAINT `stock_records_ibfk_1` FOREIGN KEY (`business_id`) REFERENCES `businesses` (`id`) ON DELETE CASCADE,
  CONSTRAINT `stock_records_ibfk_2` FOREIGN KEY (`product_id`)  REFERENCES `products`   (`id`) ON DELETE CASCADE,
  CONSTRAINT `stock_records_ibfk_3` FOREIGN KEY (`performed_by`) REFERENCES `users`     (`id`)
...
CREATE TABLE `subscription_payments` (
  ...
  CONSTRAINT `subscription_payments_ibfk_1` FOREIGN KEY (`business_id`)     REFERENCES `businesses`            (`id`) ON DELETE CASCADE,
  CONSTRAINT `subscription_payments_ibfk_2` FOREIGN KEY (`subscription_id`) REFERENCES `business_subscriptions`(`id`) ON DELETE CASCADE,
  CONSTRAINT `subscription_payments_ibfk_3` FOREIGN KEY (`plan_id`)         REFERENCES `subscription_plans`    (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `sync_conflicts` (
  ...
  CONSTRAINT `sync_conflicts_ibfk_1` FOREIGN KEY (`business_id`) REFERENCES `businesses` (`id`) ON DELETE CASCADE,
  CONSTRAINT `sync_conflicts_ibfk_2` FOREIGN KEY (`user_id`)     REFERENCES `users`      (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `sync_devices` (
  ...
  CONSTRAINT `sync_devices_ibfk_1` FOREIGN KEY (`business_id`) REFERENCES `businesses` (`id`) ON DELETE CASCADE,
  CONSTRAINT `sync_devices_ibfk_2` FOREIGN KEY (`user_id`)     REFERENCES `users`      (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `sync_logs` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_sync_logs_business_status` (`business_id`,`status`),
  KEY `idx_sync_logs_user`            (`user_id`),
  KEY `idx_sync_logs_table`           (`table_name`),
  KEY `idx_sync_logs_timestamp`       (`sync_timestamp`),

  CONSTRAINT `sync_logs_ibfk_1` FOREIGN KEY (`business_id`) REFERENCES `businesses` (`id`) ON DELETE CASCADE,
...
CREATE TABLE `tax_configurations` (
  ...
  CONSTRAINT `tax_configurations_ibfk_1` FOREIGN KEY (`business_id`) REFERENCES `businesses` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
VIEW `daily_sales_summary` AS
  ...
  GROUP BY `sales`.`business_id`, CAST(`sales`.`sale_date` AS date);

CREATE ALGORITHM=UNDEFINED
  DEFINER=`root`@`localhost`
  SQL SECURITY DEFINER
VIEW `monthly_business_metrics` AS
  SELECT
...
(19, 2, NULL, 'Salt',              'Normal salt',           NULL,  725.00,  1000.00,  0.00,  5.00, NULL, 'Pieces', NULL, NULL, 1, 2, '2026-04-27 18:45:26', '2026-05-06 19:33:33'),
